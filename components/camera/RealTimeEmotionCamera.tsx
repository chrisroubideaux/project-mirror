...
export default function RealTimeEmotionCamera({ onEmotion }: Props) {
  ...
  const captureFrame = async () => {
    ...
    try {
      ...
      // Save locally for HUD + bubble up to parent
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Face box overlay (visual only for now) */}
          {streaming && (
            <div
          ...
          {streaming && (
            ...
            >
              <div
                ...
                style={{ fontSize: '0.65rem', letterSpacing: '0.12em', color: '#9ca3af' }}
              >
                Emotion Snapshot
              </div>
        ...
        {!streaming ? (
          ...
          // PREMIUM MATTE STOP BUTTON (NO RED)
          <button
            className="btn w-100 py-2 fs-5 fw-semibold"
            style={{
              borderRadius: '14px',
          ...
          <div className="modal-dialog modal-fullscreen">
            <div className="modal-content bg-dark position-relative">
              <div className="position-relative w-100 h-100">
                ...
                {/* Scanlines & slight aurora in fullscreen */}
                <div
                  className="position-absolute top-0 start-0 w-100 h-100 scanlines-overlay"
...
export default function RealTimeEmotionCamera({ onEmotion }: Props) {
  ...
  const captureFrame = async () => {
    ...
    try {
      ...
      // send emotion result back to parent
      onEmotion(data);
